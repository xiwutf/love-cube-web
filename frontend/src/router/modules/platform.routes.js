...
export default {
  ...
  children: [
    ...
    { path: 'platform/play', component: () => import('@/pages/platform/PlayHubPage.vue'), meta: { module: 'platform' } },
    ...
    { path: 'me/following', component: () => import('@/pages/platform/MyFollowingPage.vue'), meta: { module: 'platform', requiresAuth: true } },
    { path: 'me/fans', component: () => import('@/pages/platform/MyFansPage.vue'), meta: { module: 'platform', requiresAuth: true } },
    { path: 'me/received-likes', component: () => import('@/pages/platform/MyReceivedLikesPage.vue'), meta: { module: 'platform', requiresAuth: true } },

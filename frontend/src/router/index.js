...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'me', component: () => import('@/pages/platform/AccountCenterPage.vue'), ...auth },
      { path: 'account', redirect: '/me' },
      { path: 'messages', component: () => import('@/pages/platform/MessagesCenterPage.vue'), ...auth },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'preferences', component: () => import('@/pages/fellowship/PreferencesPage.vue'), ...auth },

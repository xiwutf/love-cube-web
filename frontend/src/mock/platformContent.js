...
export const platformContentList = [
  ...
  { id: 4, title: '平台动态：发布页功能升级', summary: '支持多图预览与标签选择，发布流程更清晰。', content: '...', type: 'dynamic', cover: 'https://picsum.photos/seed/dyn4/640/360', images: [], tags: ['平台建议'], authorName: '产品团队', createdAt: '2026-04-27', likeCount: 18, commentCount: 4, pinned: false },

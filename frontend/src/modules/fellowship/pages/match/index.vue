<template>
  <div class="match-page">
    ...
    <van-dialog v-model:show="showMatched" title="🎉 认识申请通过！" :show-cancel-button="true"
                confirm-button-text="查看 TA" cancel-button-text="继续滑动"
                @confirm="goProfile" @cancel="showMatched = false">
...
import SwipeCard from '@f/components/SwipeCard.vue'
import { getMatchList, likeUser, dislikeUser, superlikeUser } from '@f/api/match.js'
...
function goProfile() {
  ...
  if (matchedUserId) router.push(`/fellowship/user-profile/${matchedUserId}`)
}
